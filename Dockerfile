...
WORKDIR $GOPATH/src/github.com/edgexfoundry/device-lte-go
...
COPY --from=builder /go/src/github.com/edgexfoundry/device-lte-go/cmd /

ENTRYPOINT ["/device-lte-go","--profile=docker","--confdir=/res","--registry=consul://edgex-core-consul:8500"]
